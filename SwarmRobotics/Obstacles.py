...
class Obstacles:
    def __init__(self, option):
        ...
        if option == 1:
            self.obstacles = [
                         ...
                         pygame.Rect(550, 500, 60, 30),
                         pygame.Rect(550, 400, 30, 30),
                         pygame.Rect(550, 200, 60, 30),
                         pygame.Rect(330, 200, 30, 30),
                         pygame.Rect(350, 100, 30, 30),
            ...
            self.obstacles = [
                         pygame.Rect(600, 150, 30, 30),
                         pygame.Rect(400, 300, 30, 30),
                         pygame.Rect(550, 500, 30, 30),
                         pygame.Rect(700, 500, 60, 30),
                         pygame.Rect(700, 300, 30, 30),
                         pygame.Rect(350, 200, 30, 30),
                         pygame.Rect(800, 250, 30, 30)]
    ...
    def collision_robot(self, robot_x, robot_y, robot_radius):
        for obstacle in self.obstacles:
            #closest point on the rect to the robots centre
